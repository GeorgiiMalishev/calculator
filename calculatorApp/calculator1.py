...
class Calculator1:
    ...
    def __init__(self, input_data):
        ...
        self.formulas = {
            ...
            'Ночь/пр/вых факт нагрузка в %': Formula(
                lambda G8, I7: 0 if I7 == 0 else G8 / I7 * 100,
            ...
            'Факт нехватка машин 168 часов': Formula(
                lambda K4, sum, F5: 0 if K4 < 86 else sum * (K4 - 86) / 86 / F5,
    ...
    def calculate(self) -> Dict[str, Any]:
        ...
        Сначала производятся точные вычисления, затем результаты округляются.
        """
        # Сначала выполняем все вычисления без округления
